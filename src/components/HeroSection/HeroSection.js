        ...
        <div className="">
          <div className="xl:ms-[15px] pt-[15px]">
            <div className="grid  grid-cols-1 sm:grid-cols-12 gap-4 ">
              <div className=" bg-slate-500 rounded-[3px] sm:col-span-12 banner1 h-[300px] sm:h-[300px]"></div>
              <div className=" bg-slate-500 rounded-[3px] sm:col-span-12 banner4 text-center py-[35px] px-[30px]">
                <NewLaunch />
              </div>
              <div className="bg-slate-500 rounded-[3px]  sm:col-span-12  banner2 h-[300px] "></div>
              <div className=" bg-slate-500 rounded-[3px]  sm:col-span-12 banner3 h-[300px]"></div>
            </div>
          </div>
        </div>
      </div>
