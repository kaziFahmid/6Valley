      ...
      <div className="bg-[var(--deep-blue-color)] py-2 hidden sm:block">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex justify-start items-center gap-5">
            <button className="bg-[var(--primary-color)] px-[12.8px] py-[2.75px] text-[13px] text-[var(--white-color)] font-bold rounded-2xl">
              Become a Seller
            </button>
            <h6 className="text-[var(--white-color)] text-[12px] font-normal">
          ...
          <div className="flex justify-between items-center gap-5">
            <ul className="list-none flex justify-start items-center gap-5">
              <li className="flex justify-start items-center gap-1">
                <h6 className="text-[var(--white-color)] text-[12px] font-semibold">
                  USD
                </h6>
