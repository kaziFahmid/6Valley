        ...
        <div className="xl:col-span-10 col-span-12 " >
          <div className="xl:ms-[15px] pt-[15px]">
            <div className="grid grid-cols-8 grid-rows-7 gap-[10px] h-[381px]">
              <div className="col-span-6 row-span-4  rounded-[3px] banner1 ">
                
              </div>
              <div className="col-span-2 row-span-7 col-start-7 rounded-[3px] banner4 text-center py-[35px] px-[30px]">
              <NewLaunch/>
              </div>
              <div className="col-span-3 row-span-3 row-start-5 rounded-[3px]   banner2 ">
            
              </div>
              <div className="col-span-3 row-span-3 col-start-4 row-start-5  rounded-[3px] banner3">
