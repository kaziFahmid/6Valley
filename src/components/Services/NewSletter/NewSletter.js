...
<div className='flex justify-start items-center gap-[6px]'>
    ...
    <div>
        <input type='email' placeholder='Enter your email' className={`w-full ${poppins.className}`}/>
    </div>
</div>
...
<div className='text-right'>
    <button className={`bg-[var(--primary-color)] text-[var(--white-color)] font-semibold text-[14px] px-[21px] py-[7.5px] rounded-[4px] ${poppins.className}`}>Submit</button>
</div>
