        ...
        <div className="container mx-auto grid grid-cols-12 ">
          ...
          <div className="lg:col-span-9 xl:col-span-10 flex justify-start items-center">
            <ul className="list-none flex justify-start items-center gap-[20px] ms-[55px]">
              <li className="text-[var(--text-color)] font-semibold text-[13px]">
                Home
              </li>
              <li className="flex justify-start items-center gap-[10px] text-[var(--text-color)] font-semibold text-[13px]">
                <span>Offers</span>
